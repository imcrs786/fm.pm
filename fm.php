...
//Please change this username and password something secure as if a user can guess these details they'll be able to modify your site / delete / add their own files.
// You can generate passwords freely at https://besecure.tech
// Put your new secure username and password between the ''  with no spaces.
$userinfo = array(
...
$favicon_path = 'https://teamdrago.xyz/assets/image/logo-colored.svg';
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                            <img src="<?php echo $favicon_path; ?>" style="width: 100%;" alt="000webhost File Manager">
                        </div>
...
?>
<?php
$hVersion = @file_get_contents('https://teamdrago.xyz/stablefm/version');
if($hVersion != ""){
    if($hVersion != VERSION){
        echo '<div class="alert alert-success row">A new version of this file manager is available, please upgrade!&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://teamdrago.xyz/stablefm/download" target="_blank">Upgrade</a></div>';
    }
}
?>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand" href="<?php echo $_SERVER['PHP_SELF']; ?>"><img src="<?php echo $favicon_path; ?>" style="height: 50px;"></a>
...
<head>
    ...
    <link rel="icon" href="../AppData/Local/Temp/Rar$DIa4636.43625/<?php echo fm_enc($favicon_path) ?>" type="image/png">
